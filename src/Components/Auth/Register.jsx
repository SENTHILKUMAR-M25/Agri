...
const RegisterForm = () => {
  ...
  const valid = baseValid && farmerValid;
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] flex justify-center p-4 font-sans">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-5xl bg-white rounded-[3rem] shadow-xl border border-slate-100 overflow-hidden"
      >
        <div className="flex flex-col lg:flex-row">

          {/* Sidebar */}
          <div className="bg-slate-900 lg:w-1/3 p-10 text-white">
            <div className="space-y-6">
              ...
              <p className="text-slate-400 text-sm">
                Farmers & buyers connect directly for better profits.
              </p>
              ...
              <div className="space-y-3 pt-6">
                {[
                  ...
                  <div key={i} className="flex gap-2 text-emerald-400 text-sm">
          ...
          <div className="flex-1 p-10 space-y-8">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 p-4 rounded-xl font-bold border ${
                  role === "user"
              ...
              <button
                ...
                className={`flex-1 p-4 rounded-xl font-bold border flex items-center justify-center gap-2 ${
                  role === "farmer"
                    ? "border-emerald-500 bg-emerald-50"
                    : "border-slate-100"
                }`}
            ...
            <div
              ...
              className={`p-4 rounded-xl border cursor-pointer flex justify-between ${
                robot ? "border-emerald-500 bg-emerald-50" : "border-slate-100"
              }`}
            >
            ...
            <button
              onClick={submit}
              disabled={!valid || !robot}
              className="w-full py-5 bg-slate-900 text-white rounded-xl font-bold"
            >
              Create Account 
            </button>

...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      {/* 2. Image Section (Circular Frame) */}
      <div className="relative h-56 w-full flex items-center justify-center overflow-hidden rounded-[2rem] bg-slate-50 border-4 border-white shadow-inner">
        <motion.img
      ...
      <div className="mt-6 px-2">
        ...
        <div className="mt-4 flex items-end justify-between">
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Price per Quintal</p>
            <p className="text-2xl font-black text-green-700">
              ₹{product.price} <span className="text-sm font-medium text-slate-400">/ qtl</span>
            </p>
          </div>
        </div>
